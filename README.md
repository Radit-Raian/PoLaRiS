...
```text
Astronomical FITS Image
        │
        ▼
FITS Inspection and Downsampling
        │
        ▼
...
Point-Source Identification
        │
        ▼
Gaia Cross-Matching and Validation
        │
        ▼
Stellar Selection and Patch Definition
        │
        ▼
Multi-scale Cutout Generation
        │
        ▼
Segmentation-based Contamination Masking
        │
        ▼
Flux Normalization and Quality Rejection
        │
        ▼
PSF Stacking
        │
...
Radial Profile Construction
        │
        ▼
Multi-patch Profile Stitching
        │
        ▼
Continuous Extended PSF Profile
```
